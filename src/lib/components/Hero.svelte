...
<div id="hero" class="mb-8 p-8">
	<div
		class="relative container mx-auto flex h-160 max-h-[80vh] max-w-6xl items-center justify-center rounded-3xl bg-cover bg-center shadow-2xl"
		style="background-image: url('/assets/hero.jpg');"
	>
		<!-- Gradient Overlay -->
		<div class="absolute inset-0 rounded-3xl bg-gradient-to-tr from-black/40 to-black/0"></div>
